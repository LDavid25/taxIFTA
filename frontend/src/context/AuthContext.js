...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (email, password) => {
    try {
      ...
      // MODO DESARROLLO: Bypass de autenticación para facilitar pruebas
      // Simular un usuario y token para desarrollo
      const mockUser = {
        id: '22222222-2222-2222-2222-222222222222',
        name: 'Administrador del Sistema',
        email: email || 'admin@iftaeasytax.com',
        role: 'admin',
      ...
      const mockToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiMjIyMjIyMjItMjIyMi0yMjIyLTIyMjItMjIyMjIyMjIyMjIyIiwicm9sZSI6ImFkbWluIiwiY29tcGFueUlkIjoiMTExMTExMTEtMTExMS0xMTExLTExMTEtMTExMTExMTExMTExIn0sImlhdCI6MTYxNjE1MzYwMCwiZXhwIjoxNjE2MjQwMDAwfQ.mock_signature';
